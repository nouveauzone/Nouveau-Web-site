...
const hasSuspiciousUpiPattern = (value) => {
  ...
  // Minimal basic sanity checks (avoid overly aggressive pattern matching that blocks valid test/real UTRs)
  if (/^(\d)\1{11}$/.test(value)) return true; // e.g. 111111111111
