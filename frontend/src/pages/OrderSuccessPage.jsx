    ...
    <div style={{background:THEME.bg,minHeight:"100vh",color:THEME.text,display:"flex",flexDirection:"column"}}>
      <div style={{flex:1,display:"flex",alignItems:"center",justifyContent:"center",padding:"60px 20px"}}>
        <div style={{maxWidth:"560px",width:"100%",textAlign:"center"}}>
          ...
          {orderId && (
            <div style={{background:THEME.bgCard,border:`1px solid ${THEME.border}`,borderRadius:"14px",padding:"20px",margin:"28px 0",display:"inline-block",width:"100%"}}>
              ...
              <p style={{fontFamily:"'Poppins',sans-serif",fontSize:"18px",fontWeight:700,color:GOLD,letterSpacing:"1px"}}>{orderId}</p>
              {order && (
